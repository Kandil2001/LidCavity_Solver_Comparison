# c_hybrid_mpi_openmp_looped

This folder contains the **C hybrid MPI + OpenMP domain decomposition** lid-driven-cavity solver using **explicit loop-based local kernels**.
