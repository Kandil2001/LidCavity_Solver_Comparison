#!/usr/bin/env python3
"""
Python MPI + threaded hybrid domain-decomposition lid-driven cavity solver
...
Kernel style: explicit Python loop kernels over local rows/cells
Hybrid mode: mpi4py plus optional Numba threaded loop kernels where available
"""
...
KERNEL_STYLE = "looped"
IMPLEMENTATION = "python_hybrid_mpi_threaded_looped"
HYBRID = True
