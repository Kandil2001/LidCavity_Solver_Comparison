# python_mpi_domain_vectorized

This folder contains the **PYTHON pure MPI domain decomposition** lid-driven-cavity solver using **NumPy vectorized local kernels**.
