# python_hybrid_mpi_threaded_looped

This folder contains the **PYTHON hybrid MPI + OpenMP domain decomposition** lid-driven-cavity solver using **explicit loop-based local kernels**.
