# python_mpi_domain_looped

This folder contains the **PYTHON pure MPI domain decomposition** lid-driven-cavity solver using **explicit loop-based local kernels**.
