# c_mpi_domain_vectorized

This folder contains the **C pure MPI domain decomposition** lid-driven-cavity solver using **SIMD/vectorization-friendly local kernels**.
