# c_hybrid_mpi_openmp_vectorized

This folder contains the **C hybrid MPI + OpenMP domain decomposition** lid-driven-cavity solver using **SIMD/vectorization-friendly local kernels**.
