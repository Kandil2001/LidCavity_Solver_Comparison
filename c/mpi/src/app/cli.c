...
static void config_defaults(Config *cfg) {
    ...
    cfg->n_impl = 2; snprintf(cfg->implementations[0],32,"serial_c_vectorized"); snprintf(cfg->implementations[1],32,"serial_c_looped");
...
static void print_usage(const char *exe) {
    ...
    printf("  %s --single --N 64 --Re 100 --scheme central --pressure RBGS --implementation serial_c_looped\n", exe);
    printf("  %s --single --N 64 --Re 100 --scheme central --pressure RBGS --implementation serial_c_vectorized\n\n", exe);
    printf("Options:\n");
...
int main(int argc, char **argv) {
    ...
    char single_impl[32] = "serial_c_looped";
    ...
    printf("\nLID-DRIVEN CAVITY C SOLVER: serial looped + vectorized-style labels\n");
    printf("Mode: %s\n", mode);
