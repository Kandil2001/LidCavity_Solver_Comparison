...
run_mpi_if_available() {
    echo "Skipping old case-level MPI sweep: those folders were removed from the cleaned package."
    echo "For real domain decomposition, run: bash scripts/run_domain_solver_benchmark.sh"
}
