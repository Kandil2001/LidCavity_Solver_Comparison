...
static void config_defaults(Config *cfg) {
    ...
    cfg->n_impl = 1; snprintf(cfg->implementations[0],32,"serial_c");
...
static void print_usage(const char *exe) {
    ...
    printf("  %s --single --N 64 --Re 100 --scheme central --pressure RBGS --implementation serial_c\n\n", exe);
    printf("Options:\n");
...
int main(int argc, char **argv) {
    ...
    printf("\nLID-DRIVEN CAVITY C SOLVER: serial C baseline\n");
    printf("Mode: %s\n", mode);
